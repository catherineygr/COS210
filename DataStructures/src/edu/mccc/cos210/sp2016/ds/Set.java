...
public class Set<E> implements ISet<E>, Iterable<E> {
	private IVector<IList<E>> theVector = new Vector<>(10);
	private int size = 0;
	public Set() {
	...
	private void increaseCapacity() {
		IVector<IList<E>> newVector = new Vector<>(theVector.getCapacity() * 2);
